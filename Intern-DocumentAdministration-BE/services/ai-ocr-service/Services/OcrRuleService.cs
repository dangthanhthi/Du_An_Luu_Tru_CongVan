        ...
        public static List<OcrPatternRule> GetDefaultRules()
        {
            return new List<OcrPatternRule>
            {
                ...
                new()
                {
                    ...
                    Pattern = @"(?:^|\n|[\s(])(?:Về việc|Ve viec|VỀ VIỆC)[:.]?\s*([\s\S]{5,300}?(?=(?:Kính|K[ií]nh|Căn cứ|Điều \d|Nơi nhận|TỔNG GIÁM ĐỐC|GIÁM ĐỐC|CHỦ TỊCH|BỘ TRƯỞNG|THỦ TƯỚNG|CỔNG THÔNG TIN|CNG THONG TIN|CONG THONG TIN|VGP|\n\s*\n|$)))",
                    Priority = 1,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Pattern = @"(?:^|\n|[\s(])(?:\bV\/v|\bV\/V|\bv\/v|\bV\.v\b|\bVv\b)[:.]?\s*([\s\S]{5,300}?(?=(?:Kính|K[ií]nh|Căn cứ|Điều \d|Nơi nhận|TỔNG GIÁM ĐỐC|GIÁM ĐỐC|CHỦ TỊCH|BỘ TRƯỞNG|THỦ TƯỚNG|CỔNG THÔNG TIN|CNG THONG TIN|CONG THONG TIN|VGP|\n\s*\n|$)))",
                    Priority = 2,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Pattern = @"(?:^|\n|[\s(])(?:Trích yếu|Trich yeu|TRÍCH YẾU)[:.]?\s*([\s\S]{5,300}?(?=(?:Kính|K[ií]nh|Căn cứ|Điều \d|Nơi nhận|TỔNG GIÁM ĐỐC|GIÁM ĐỐC|CHỦ TỊCH|BỘ TRƯỞNG|THỦ TƯỚNG|CỔNG THÔNG TIN|CNG THONG TIN|CONG THONG TIN|VGP|\n\s*\n|$)))",
                    Priority = 3,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Pattern = @"(?:^|\n)\s*(?:THÔNG BÁO|QUYẾT ĐỊNH|GIẤY MỜI|TỜ TRÌNH|CHỈ THỊ)\s*\n\s*([\s\S]{5,300}?(?=(?:Kính|K[ií]nh|Căn cứ|Điều \d|Nơi nhận|TỔNG GIÁM ĐỐC|GIÁM ĐỐC|CHỦ TỊCH|BỘ TRƯỞNG|THỦ TƯỚNG|CỔNG THÔNG TIN|CNG THONG TIN|CONG THONG TIN|VGP|\n\s*\n|$)))",
                    Priority = 4,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Pattern = @"(?:^|\n|[\s(])(?:Regarding|regarding|\bRe\b|\bRE\b)[:.]?\s*([\s\S]{5,500}?(?=(?:To:|Dear|\n\s*\n|$)))",
                    Priority = 5,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Pattern = @"(?:^|\n|[\s(])(?:Subject|SUBJECT)[:.]?\s*([\s\S]{5,500}?(?=(?:To:|Dear|\n\s*\n|$)))",
                    Priority = 6,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Name = "Chuẩn Nghị định 30 (Số: .../...-...)",
                    Pattern = @"(?:Số|So|No|Số/No|Số\s*\/\s*No)\s*[:.]?\s*([0-9]+\s*\/[A-Z0-9Đa-z\-_]+(?:\s*\/[A-Z0-9Đa-z\-_]+)*(?:-[A-Z0-9Đa-z\-_]+)*)",
                    Priority = 1,
                    IsActive = true,
                    Description = "Bóc tách số công văn dạng 'Số: 128/BGDĐT-GDĐH', 'Số: 45/UBND-VX'"
                },
                new()
                {
                    RuleType = "ReferenceNumber",
                    Name = "Số công văn không dấu hai chấm",
                    Pattern = @"\b(?:Số|So)\s+([0-9]+\s*\/[A-Z0-9Đa-z\-_]+(?:\s*\/[A-Z0-9Đa-z\-_]+)*(?:-[A-Z0-9Đa-z\-_]+)*)",
                    Priority = 2,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Pattern = @"(?:Ref|Reference)\s*(?:No|Number|\.)?\s*[:.]\s*([0-9A-Za-zÀ-ỹ\/\-_.]{2,40})",
                    Priority = 3,
                    IsActive = true,
                ...
                new()
                {
                    ...
                    Pattern = @"(?:KT\.\s*BỘ TRƯỞNG|THỨ TRƯỞNG|TỔNG GIÁM ĐỐC|GIÁM ĐỐC|CHỦ TỊCH|PHÓ CHỦ TỊCH|PHÓ TỔNG GIÁM ĐỐC|PHÓ GIÁM ĐỐC|TRƯỞNG PHÒNG|VIỆN TRƯỞNG|HIỆU TRƯỞNG|CHÁNH VĂN PHÒNG|TRƯỞNG BAN)[\s\S]{1,120}?\n\s*([A-ZÀÁẢÃẠĂẮẰẲẴẶÂẤẦẨẪẬÈÉẺẼẸÊẾỀỂỄỆÌÍỈĨỊÒÓỎÕỌÔỐỒỔỖỘƠỚỜỞỠỢÙÚỦŨỤƯỨỪỬỮỰỲÝỶỸỴĐa-zàáảãạăắằẳẵặâấầẩẫậèéẻẽẹêếềểễệìíỉĩịòóỏõọôốồổỗộơớờởỡợùúủũụưứừửữựỳýỷỹỵđ\s]{3,40})",
                    Priority = 1,
                    IsActive = true,
