            ...
            <div className="space-y-5 text-xs font-semibold">
              ...
              <div className="pt-4 border-t border-zinc-900 space-y-3">
                ...
                <button
                  ...
                  className="w-full mt-2 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-[11px] font-bold transition-all cursor-pointer shadow-md flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50"
                >
                  {manualScanning ? (
                    <>
                    ...
                    <>
                      <span>⚡ Quét email thủ công ngay</span>
                    </>
                  )}
                </button>
