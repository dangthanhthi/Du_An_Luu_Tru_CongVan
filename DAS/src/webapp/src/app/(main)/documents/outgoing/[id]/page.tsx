...
export default function OutgoingDocDetail() {
  ...
  const doc = customDoc ? {
    ...
    department: 'Ban Giám đốc',
    date: '18/07/2026',
    status: signed ? 'Đã ký số & Phát hành' : 'Chờ xử lý',
    priority: 'Khẩn',
    recipient: 'Ngân hàng Vietcombank - Chi nhánh Hà Nội',
    summary: 'Chấp thuận bổ nhiệm ông Lê Văn B làm Trưởng nhóm Kế toán tổng hợp kể từ ngày 01/08/2026.'
  };

  const handleSign = () => {
    if (pinCode === '1234' || pinCode.length >= 4) {
      setSigned(true);
      localStorage.setItem(`signed-doc-outgoing-${docId}`, 'true');
      const now = new Date();
      setSignedDate(now.toLocaleString('vi-VN'));
      setHashValue('a' + Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15));
  ...
  return (
    <>
      <Header title={`Chi tiết Công văn đi: ${doc.docNo}`} />
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-zinc-950 p-4 border border-zinc-800 rounded-xl shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <span className={`px-2.5 py-0.5 text-xs rounded-full font-bold border ${
              ...
              {signed ? '● Đã ký số & Phát hành' : '○ Chờ xử lý (Chưa ký)'}
            </span>
          </div>
              ...
              <div className="p-8 bg-zinc-950 border border-zinc-800 rounded-xl space-y-6 shadow-sm relative overflow-hidden">
                ...
                <div className="border-b border-zinc-800 pb-6 flex justify-between items-start text-xs font-serif">
                  ...
                  <div className="text-center space-y-1">
                    ...
                    <p className="text-zinc-500 text-[10px] italic">Hà Nội, ngày 18 tháng 07 năm 2026</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 py-2">
                  ...
                  <div className="text-xs text-zinc-300 leading-relaxed space-y-3 font-serif">
                    <p>- Căn cứ Điều lệ tổ chức và hoạt động của Công ty CP DAS Enterprise;</p>
                    <p>- Căn cứ nhu cầu công tác và năng lực cán bộ phòng Kế toán doanh nghiệp;</p>
                    <p className="font-bold text-white pt-2">QUYẾT ĐỊNH:</p>
                    <p><span className="font-bold text-white">Điều 1:</span> Bổ nhiệm ông Lê Văn B giữ chức vụ Trưởng nhóm Kế toán tổng hợp thuộc Phòng Kế toán doanh nghiệp.</p>
                    <p><span className="font-bold text-white">Điều 2:</span> Quyết định này có hiệu lực kể từ ngày ký. Các phòng ban liên quan chịu trách nhiệm thi hành.</p>
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-zinc-800 flex justify-between items-end text-xs font-serif">
                  <div className="space-y-1 text-zinc-400">
                    ...
                    <p>- Như trên;</p>
                    <p>- Vietcombank Chi nhánh Hà Nội;</p>
                    <p>- Lưu: VT, Kế toán.</p>
                  </div>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-zinc-950 border border-zinc-800 rounded-xl space-y-4 shadow-sm">
                ...
                <div className="space-y-3 text-xs">
                  <div>
                    <span className="text-zinc-500 block text-[10px] font-bold uppercase">Nơi nhận:</span>
                    <span className="font-semibold text-white">{doc.recipient}</span>
                  </div>
                  <div>
