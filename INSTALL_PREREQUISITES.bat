...
echo ==============================================================================
echo   TU DONG KIEM TRA VA CAI DAT MOI TRUONG CHAY DU AN (.NET & NODE.JS)
echo ==============================================================================
echo.
...
if %errorlevel% equ 0 (
    ...
    echo    - May chua co .NET SDK. Dang tu dong cai dat Microsoft .NET SDK qua winget...
    ...
    if %errorlevel% neq 0 (
        ...
        powershell -ExecutionPolicy Bypass -Command "Invoke-WebRequest -Uri 'https://dot.net/v1/dotnet-install.ps1' -OutFile 'dotnet-install.ps1'; & ./dotnet-install.ps1 -Channel 8.0"
    )
...
if %errorlevel% equ 0 (
    ...
    if %errorlevel% neq 0 (
        echo    - Dang tai bo cai dat MSI tu trang chu nodejs.org...
